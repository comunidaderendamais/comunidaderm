...
revoke all on function public.admin_daily_payout_monitor(date) from public;
grant execute on function public.admin_daily_payout_monitor(date) to authenticated;
