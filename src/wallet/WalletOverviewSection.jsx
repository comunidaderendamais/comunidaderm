  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 min-[540px]:grid-cols-3">
        <MetricCard
          icon={Wallet}
          label={t.walletHeroAvailableLabel}
          value={availableBalance}
          hint={t.walletMetricAvailableHint}
          accentClass="border-violet-100 bg-violet-50 text-violet-600"
        />
        <MetricCard
          icon={TrendingUp}
          label={t.walletHeroCyclesLabel}
          value={String(activeCyclesCount)}
          hint={t.walletMetricCyclesHint}
          accentClass="border-emerald-100 bg-emerald-50 text-emerald-600"
        />
        <MetricCard
          icon={CreditCard}
          label={t.walletHeroPendingLabel}
          value={String(pendingDepositsCount)}
          hint={t.walletMetricPendingHint}
