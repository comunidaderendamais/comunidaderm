...
const CardShell = ({ icon: Icon, accentClass, badge, title, subtitle, value, valueClassName = '', children, hint }) => (
  <div className="rounded-[28px] border border-white/70 bg-white/95 p-5 shadow-[0_24px_70px_-40px_rgba(15,23,42,0.35)] backdrop-blur">
...
export default function TeamOverviewSection({
  ...
  return (
    <div className="space-y-6">
      <div className="relative overflow-hidden rounded-[32px] border border-[#8A2BE2]/60 bg-[radial-gradient(circle_at_top_left,rgba(138,43,226,0.24),transparent_38%),radial-gradient(circle_at_bottom_right,rgba(0,255,0,0.16),transparent_30%),linear-gradient(135deg,#050816_0%,#0b1225_55%,#111827_100%)] p-6 shadow-[0_28px_90px_-45px_rgba(138,43,226,0.55)] sm:p-8">
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)]">
        <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-[0_24px_70px_-40px_rgba(15,23,42,0.3)]">
